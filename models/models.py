...
def potato_predict_h5_us(bytes):
    # img = cv2.cvtColor(img,cv2.COLOR_BGR2RGB) color is already in rgb
    model = tf.keras.models.load_model("models\potato_disease_detection_model.h5")
